...
📖 [View in docs](https://reference.langchain.com/javascript/langchain-mcp-adapters)
...
For more detailed examples, see the [examples](https://github.com/langchain-ai/langchainjs/tree/29ce876dc5e6b3af9359e5101a35754cfbcc23d9/libs/langchain-mcp-adapters/examples) directory.
...
Contributions are welcome! Please check out our [contributing guidelines](https://github.com/langchain-ai/langchainjs/blob/29ce876dc5e6b3af9359e5101a35754cfbcc23d9/libs/langchain-mcp-adapters/CONTRIBUTING.md) for more information.

## Classes

- [`MultiServerMCPClient`](https://reference.langchain.com/javascript/langchain-mcp-adapters/MultiServerMCPClient)

## Functions

- [`loadMcpTools()`](https://reference.langchain.com/javascript/langchain-mcp-adapters/loadMcpTools)

## Types

- [`ClientConfig`](https://reference.langchain.com/javascript/langchain-mcp-adapters/ClientConfig)
- [`Connection`](https://reference.langchain.com/javascript/langchain-mcp-adapters/Connection)
- [`LoadMcpToolsOptions`](https://reference.langchain.com/javascript/langchain-mcp-adapters/LoadMcpToolsOptions)
- [`MCPResource`](https://reference.langchain.com/javascript/langchain-mcp-adapters/MCPResource)
- [`MCPResourceContent`](https://reference.langchain.com/javascript/langchain-mcp-adapters/MCPResourceContent)
- [`MCPResourceTemplate`](https://reference.langchain.com/javascript/langchain-mcp-adapters/MCPResourceTemplate)
- [`OutputHandling`](https://reference.langchain.com/javascript/langchain-mcp-adapters/OutputHandling)
- [`SSEConnection`](https://reference.langchain.com/javascript/langchain-mcp-adapters/SSEConnection)
- [`StdioConnection`](https://reference.langchain.com/javascript/langchain-mcp-adapters/StdioConnection)
- [`StreamableHTTPConnection`](https://reference.langchain.com/javascript/langchain-mcp-adapters/StreamableHTTPConnection)
